    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChallengeIngredients", x => new { x.ChallengeId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_ChallengeIngredients_Challenges_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "Challenges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChallengeIngredients_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecipeId = table.Column<Guid>(type: "uuid", nullable: false),
                    IngredientId = table.Column<Guid>(type: "uuid", nullable: false),
                    Quantity = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengeIngredients_IngredientId",
                table: "ChallengeIngredients",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_Challenges_Status_EndsAt",
                table: "Challenges",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_IsPublished_CreatedAt",
                table: "Recipes",
